...
/*---- Google Map ----*/
	...
	function initialize() {
		...
		var secheltLoc = new google.maps.LatLng(26.9367111,75.7926488);
		...
		var marker = new google.maps.Marker({
			map: theMap,
			draggable: false,
			position: new google.maps.LatLng(26.9367111,75.7926488),
			icon: image,
			visible: true
		});
		...
		var contentString = '<div id="content-boolean">'+
	      '<h1>SS Dental arts</h1>'+
	      '<p>G-56, Subash Nagar, Subhash Nagar, Jaipur</p>'+
	      '<p>9632725300</p>'+
	      '</div>';
